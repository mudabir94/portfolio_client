               ...
               {/* <!-- Services Grid --> */}
                        <div className="row services-grid">
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-4">
                                <div className="services-item text-center wow fadeIn" data-wow-delay="0" data-wow-duration="1.5s" data-wow-offset="0">
                                    ...
                                    <h3 className="services-title">Branding</h3>
                            ...
                            {/* <!-- Services Item --> */}
                            <div className="col-sm-6 col-md-4 col-lg-4">
                                <div className="services-item text-center wow fadeIn" data-wow-delay=".1s" data-wow-duration="1.5s" data-wow-offset="0">
                                    <div className="services-icon">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
                                            <path d="M5 22h4v-3h-9v-18h24v18h-10v3h4v1h-13v-1zm5-3v3h3v-3h-3zm13-17h-22v16h22v-16z"/>
                                        </svg>
                                    </div>
                                    <h3 className="services-title">Web Desing</h3>
                                    <div className="services-descr">
                            ...
                            {/* <!-- Services Item --> */}
                            <div className="col-sm-6 col-md-4 col-lg-4">
                                <div className="services-item text-center wow fadeIn" data-wow-delay=".2s" data-wow-duration="1.5s" data-wow-offset="0">
                                    <div className="services-icon">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
                            ...
                            {/* <!-- Services Item --> */}
                            <div className="col-sm-6 col-md-4 col-lg-4">
                                <div className="services-item text-center wow fadeIn" data-wow-delay=".0s" data-wow-duration="1.5s" data-wow-offset="0">
                                    <div className="services-icon">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
                                    ...
                                    <h3 className="services-title">Research</h3>
                                    <div className="services-descr">
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-4">
                                <div className="services-item text-center wow fadeIn" data-wow-delay=".1s" data-wow-duration="1.5s" data-wow-offset="0">
                                    ...
                                    <h3 className="services-title">Development</h3>
                                    <div className="services-descr">
                            ...
                            <div className="col-sm-6 col-md-4 col-lg-4">
                                <div className="services-item text-center wow fadeIn" data-wow-delay=".2s" data-wow-duration="1.5s" data-wow-offset="0">
                                    ...
                                    <h3 className="services-title">Production</h3>
                                    <div className="services-descr">
